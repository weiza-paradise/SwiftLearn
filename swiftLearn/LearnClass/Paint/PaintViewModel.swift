...
struct PaintViewModel {
    ...
    let paintListData : [ClassInfo] = [
        ClassInfo(name: "UIBezierPath 属性、方法", class: BezierPathPropertyViewController.self),
        ClassInfo(name: "画直线", class: PaintLineViewController.self),
        ClassInfo(name: "画阴影图", class: PaintShadowViewController.self),
        ClassInfo(name: "画三角形", class: PaintTriangleViewController.self),
        ClassInfo(name: "画圆形椭圆形", class: PaintCilcleViewController.self),
        ClassInfo(name: "画圆角矩形", class: PaintRoundedRectangleViewController.self),
        ClassInfo(name: "画弧线", class: PaintTrajectoryViewViewController.self),
        ClassInfo(name: "LineCap形状", class: PaintLineCapViewController.self),
        ClassInfo(name: "二次贝塞尔曲线", class: QuadRaticBezierViewController.self),
        ClassInfo(name: "三次贝塞尔曲线", class: TripleBezierViewController.self),
        ClassInfo(name: "绘制饼状图", class: PieChartViewController.self),
        ClassInfo(name: "layer动画", class: LayerAnimationViewController.self),
        ClassInfo(name: "不规则渐变色图形", class: IrregularGradientViewController.self),
        ClassInfo(name: "CATextLayer", class: TextLayerViewController.self),
        ClassInfo(name: "贝塞尔曲线计算", class: CalculationViewController.self),
